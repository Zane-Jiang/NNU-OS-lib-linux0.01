...
<div class="layui-nav layui-bg-green st-header">
    ...
    <li class="layui-nav-item right" lay-unselect=""
        style="margin-right: 60px;display:${sessionScope.isLogin?"none":"block"}">
        <a href="/index" style="">
    ...
    <li class="layui-nav-item right" lay-unselect=""
        style="display:${sessionScope.isLogin?"block":"none"};margin-right: 20px">
...
<%--            <c:if test="${sessionScope.myInfo.type == 'user'}">--%>
                <dd><a href="/user?id=${sessionScope.myInfo.id}">个人主页</a></dd>
